...
// class DepartmentsEditOfferController {
...
//   // ValueNotifiers para campos seleccionables
...
//   DepartmentsEditOfferController(this.offerData) {
//     _loadInitialData();
//   }

//   void _loadInitialData() {
//     // Cargar datos de la oferta en los controladores
...
//     // Cargar fechas
//     if (offerData['startDate'] != null) {
//       fechaInicio.value = DateTime.tryParse(offerData['startDate']);
//     }
//     if (offerData['endDate'] != null) {
//       fechaFinal.value = DateTime.tryParse(offerData['endDate']);
//     }
//   }
...
//       'coversTuition': cubreDerechosEstudios.value,
//       'weeklyHours': recHorasSemanales.value,
//       'semesterHours': recHorasSemestrales.value,
//       'selectedHours': horasSeleccionadas.value.toList(),
//       'certificate': certificadoAsistencia.value,
//       'totalHours': int.tryParse(horasController.text),
//       'students': int.tryParse(estudiantesController.text),
//       'professors': profesoresController.text,
//       'minGPA': promedioPonderado.value,
//       'minCredits': creditosAprobados.value,
//       'requiredCourses': noAplicaCursos.value ? null : cursosController.text,
//       'noCoursesRequired': noAplicaCursos.value,
//       'startDate': fechaInicio.value?.toIso8601String(),
//       'endDate': fechaFinal.value?.toIso8601String(),
//     };
//   }
// }
