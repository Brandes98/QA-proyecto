import 'package:app_tecsolutions/pages/Departments/controllers/departments_student_managment_controller.dart';
import 'package:flutter/material.dart';
import '../../../components/component_views/app_bar_view.dart';
import '../../../components/component_views/bottom_bar_view.dart';
import 'package:provider/provider.dart';

class DepartmentStudentManagementView extends StatefulWidget {
  @override
  _DepartmentStudentManagementViewState createState() =>
      _DepartmentStudentManagementViewState();
}

class _DepartmentStudentManagementViewState
    extends State<DepartmentStudentManagementView>
    with AutomaticKeepAliveClientMixin {
  DepartmentStudentManagementController? controller;
  ...
  void initState() {
    super.initState();
    controller = DepartmentStudentManagementController();
    ...
    if (!_initialized && mounted && !_loadStarted) {
      ...
      Future.delayed(Duration.zero, () {
        if (mounted &&
          ...
          controller!.fetchStudentsForProfessor1(context);
        }
        _initialized = true;
      });
    }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBarView(
        isMainPage: true,
        title: "Estudiantes del Departamento",
        onBackPressed: () {
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 16),
            ElevatedButton(
              onPressed: () => ctrl.fetchStudentsForProfessor1(context),
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 16),
            Text(
              'No hay estudiantes asociados al departamento',
    ...
    return Container(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          hintText: 'Buscar por nombre, carnet o profesor',
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 8),
            _buildInfoRow('Profesor:', student['professor'] ?? 'N/A'),
            SizedBox(height: 8),
  ...
  void _deleteStudent(int index) async {
    ...
    if (confirmed == true) {
      final success = await controller!
          .finalizeStudentAssistance1(context, offerId, studentCarnet);
  ...
  void _manageStudent(int index) async {
    ...
    if (selectedOption != null && selectedOption.isNotEmpty) {
      ...
      switch (selectedOption) {
        ...
        case 'Rechazada':
          success = await controller!
              .rejectedStudentAssistance1(context, offerId, studentCarnet);
        ...
        case 'Pending being reviewed':
          success = await controller!.pendingBeingReviewedStudentAssistance1(
        ...
        case 'Requires more info':
          success = await controller!.requiresMoreInfoStudentAssistance1(
              context, offerId, studentCarnet);
          successMessage = 'Estado cambiado a "Requiere más información"';
          errorMessage = controller?.errorMessage ?? 'Error al cambiar estado';
          break;
        case 'Solicit an interview':
          success = await controller!.solicitAnInterviewStudentAssistance1(
              context, offerId, studentCarnet);
