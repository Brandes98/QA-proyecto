...
class ProfessorsStudentManagmentController with ChangeNotifier {
  final TextEditingController searchController = TextEditingController();
  List<Map<String, dynamic>> students = [];
  List<Map<String, dynamic>> filteredStudents = [];
  final String baseUrl = 'http://localhost:10000/api'; //http://10.0.2.2:10000/api/offers/by-teacher/67df4243b6e3f20a8b03a56e
  ...
  ProfessorsStudentManagmentController() {
 ...
 */
Future<bool> finalizeStudentAssistance(BuildContext context, String offerId, String studentCarnet) async {
  if (_isDisposed || isLoading) return false;
...
Future<bool> rejectedStudentAssistance(BuildContext context, String offerId, String studentCarnet) async {
  if (_isDisposed || isLoading) return false;
...
Future<bool> pendingBeingReviewedStudentAssistance(BuildContext context, String offerId, String studentCarnet) async {
  if (_isDisposed || isLoading) return false;
...
Future<bool> requiresMoreInfoStudentAssistance(BuildContext context, String offerId, String studentCarnet) async {
  if (_isDisposed || isLoading) return false;
...
Future<bool> solicitAnInterviewStudentAssistance(BuildContext context, String offerId, String studentCarnet) async {
  if (_isDisposed || isLoading) return false;
