...
class ProfessorsOffersListController {
  ...
  ProfessorsOffersListController() {
...
// Método para eliminar una oferta del backend
  ...
  Map<String, dynamic> _mapMongoOfferToFrontend(Map<String, dynamic> data) {
    ...
    return {
      ...
      //  'weeklyHours': data['weekly_hours'] ?? false,
      'weeklyHours': data['weekly_hours_recognition'] ?? false,
      //'semesterHours': data['semester_hours'] ?? false,
  ...
  //Metodo para cerrar una oferta manualmente
  bool canBeManuallyClosed(Map<String, dynamic> offer) {
    final required = offer['students'] ?? 0;
    final applicants = offer['applicants'] ?? 0;

    return applicants == required;
  }

// Método para cerrar una oferta manualmente
