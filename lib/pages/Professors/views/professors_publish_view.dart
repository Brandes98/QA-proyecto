...
import '../controllers/professors_publish_controller.dart';
import '../../../components/constants/constants.dart';

class ProfessorsPublishView extends StatefulWidget {
  const ProfessorsPublishView({super.key});

  @override
  State<ProfessorsPublishView> createState() => _ProfessorsPublishViewState();
}

class _ProfessorsPublishViewState extends State<ProfessorsPublishView> {
  late final ProfessorsPublishController _controller;
  List<String> horarios = []; // Lista para almacenar los horarios

  @override
  void initState() {
    super.initState();
    _controller = ProfessorsPublishController();
