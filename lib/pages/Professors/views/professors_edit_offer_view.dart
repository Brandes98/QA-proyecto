...
import '../controllers/professors_edit_offer_controller.dart';
import '../../../components/constants/constants.dart';

class ProfessorsEditOfferView extends StatefulWidget {
  final Map<String, dynamic> offerData;
  final Future<Map<String, dynamic>?> Function(String offerId)
      refetchOffer; //  La "función teléfono"
  const ProfessorsEditOfferView(
      {super.key, required this.offerData, required this.refetchOffer});

  @override
  _ProfessorsEditOfferViewState createState() =>
      _ProfessorsEditOfferViewState();
}

class _ProfessorsEditOfferViewState extends State<ProfessorsEditOfferView> {
  late final ProfessorsEditOfferController _controller;
  List<String> horarios = []; // Lista para almacenar los horarios
  ...
  void initState() {
    ...
    _controller = ProfessorsEditOfferController(widget.offerData);
